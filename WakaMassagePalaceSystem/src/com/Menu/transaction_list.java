 ...
 */
public class transaction_list extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tran. #", "Date", "Therapist", "Customer's Name", "Room #", "Promo ID", "Status", "Payment Status", "Time-Started", "Time-Ended"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(transaction_list.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new transaction_list().setVisible(true);
            }
        });
    }
